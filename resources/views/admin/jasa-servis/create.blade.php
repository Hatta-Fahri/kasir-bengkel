...
@section('page_title', 'Tambah Jasa Servis')
...
<div class="max-w-xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
        ...
        <div>
            <h2 class="text-lg font-bold text-gray-800">Jasa Servis Baru</h2>
            <p class="text-sm text-gray-400 mt-0.5">Isi detail pekerjaan dan estimasi biayanya</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.jasa-servis.store') }}" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input id="nama_jasa" type="text" name="nama_jasa" value="{{ old('nama_jasa') }}"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="estimasi_biaya" type="number" name="estimasi_biaya" value="{{ old('estimasi_biaya') }}"
            ...
            <div>
                ...
                <textarea id="keterangan" name="keterangan" rows="2"
                    ...
                    class="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400 resize-none">{{ old('keterangan') }}</textarea>
            </div>

            <div class="flex items-center gap-3">
                <input id="is_aktif" type="checkbox" name="is_aktif" value="1" {{ old('is_aktif', true) ? 'checked' : '' }}
            ...
            <div class="flex items-center gap-3 pt-2">
                <button type="submit" id="btn-simpan-jasa"
