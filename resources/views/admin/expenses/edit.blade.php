...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h2 class="text-lg font-bold text-gray-800 mb-1">Edit Data Pengeluaran</h2>
        <p class="text-sm text-gray-400 mb-6">Dicatat oleh: <span class="font-medium text-gray-600">{{ $expense->admin->name ?? '—' }}</span></p>

        <form method="POST" action="{{ route('admin.expenses.update', $expense) }}" id="form-edit-pengeluaran">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input id="nama_pengeluaran" name="nama_pengeluaran" type="text"
                        value="{{ old('nama_pengeluaran', $expense->nama_pengeluaran) }}"
                ...
                <div>
                    ...
                    <input id="kategori" name="kategori" type="text"
                        value="{{ old('kategori', $expense->kategori) }}"
                        list="kategori-list"
                ...
                <div>
                    ...
                    <input id="tanggal_pengeluaran" name="tanggal_pengeluaran" type="date"
                        value="{{ old('tanggal_pengeluaran', $expense->tanggal_pengeluaran->toDateString()) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input id="jumlah" name="jumlah" type="number" min="1" step="1000"
                            ...
                            class="w-full pl-10 pr-4 py-2.5 text-sm border {{ $errors->has('jumlah') ? 'border-red-400' : 'border-gray-200' }} rounded-xl focus:outline-none focus:ring-2 focus:ring-red-400">
                    </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                        class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-400 resize-none">{{ old('keterangan', $expense->keterangan) }}</textarea>
                </div>
            </div>

            <div class="flex items-center gap-3 mt-6 pt-5 border-t border-gray-100">
                <button type="submit" id="btn-update-pengeluaran"
